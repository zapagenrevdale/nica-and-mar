...
const Hero = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col justify-center items-center p-10 text-text-brown  relative w-screen h-screen bg-no-repeat bg-cover bg-top bg-fixed overflow-hidden"
      style={{
